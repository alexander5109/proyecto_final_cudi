...
BEGIN
    ...
    VALUES 
        ('Dr. Ricardo', 'Arjona', 'Buenos Aires', 'Av. Siempre Viva 123', 'Capital Federal', 'Cardiólogo', '1234567890', 1, '20220115', 185000.50, '12345678'),
        ('Dr. Tocando', 'Shells', 'Córdoba', 'Calle Falsa 456', 'Villa Carlos Paz', 'Ginecólogo', '2345678901', 0, '20210520', 192000.00, '87654321'),
        ('Dr. Mario', 'Socolinsky', 'Mendoza', 'Ruta 40 Km 12', 'Godoy Cruz', 'Pediatra', '3456789012', 1, '20200910', 178000.75, '11223344'),
        ('Dra. Roxana', 'Toledo', 'Salta', 'Calle San Martin 100', 'Salta', 'Masajista', '4567890123', 0, '20230205', 199000.25, '55667788'),
        ('Dra. Tete', 'Falopa', 'Santa Fe', 'Boulevard Galvez 2000', 'Rosario', 'Curadora', '5678901234', 1, '20191225', 186000.00, '99887766'),
        ('Dra. Debora', 'Meltrozo', 'Buenos Aires', 'Ruta 40 Km 10', 'Uruguay', 'Traumatóloga', '1238909252', 1, '20241005', 300000.00, '40350997'),
        ('Dr. Miguel', 'DedoGordo', 'Buenos Aires', 'Ruta 40 Km 13', 'Italia', 'Proctólogo', '2348905216', 0, '20211003', 543555.00, '54355292'),
        ('Dr. Felipe', 'Estomagón', 'Chaco', 'Av. Curva Peligrosa 78', 'Resistencia', 'Gastroenterólogo', '6781234567', 1, '20230714', 755000.00, '65432198'),
        ('Dr. Paco', 'Lespiedras', 'Misiones', 'Ruta de Tierra 99', 'Posadas', 'Osteópata', '7892345678', 0, '20221101', 835000.75, '45678901'),
        ('Dra. Clara', 'Mentoni', 'La Pampa', 'Calle Polvorienta 101', 'Santa Rosa', 'Cardióloga', '8903456789', 1, '20200420', 700500.25, '11225588');
END;
GO
