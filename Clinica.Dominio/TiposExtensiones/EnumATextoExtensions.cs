...
public static class EnumATextoExtensions {
	//public static string ATextoDiaYHoras(this TimeSpan hora) => hora.ToString(@"hh\:mm");
	...
	public static string ATexto(this DateOnly fecha) => fecha.ToString("yyyy/MM/dd");
	public static string ATextoDia(this DateTime fecha) => fecha.ToString("yyyy/MM/dd");
	public static string ATextoHoras(this DateTime fechaHora) => fechaHora.ToString("HH:mm");
	public static string ATextoDiaYHoras(this DateTime fechaHora) => fechaHora.ToString("yyyy/MM/dd HH:mm");
