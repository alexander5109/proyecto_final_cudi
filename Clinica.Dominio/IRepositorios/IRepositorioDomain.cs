...
public interface IRepositorioDomain {
	...
	Task<Result<Usuario2025>> SelectUsuarioWhereNombre(NombreUsuario nombre); //need domain entitiy because this is not really data to query, it's data that immediatly needs domain methods.
}
