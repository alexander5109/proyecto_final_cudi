...
public interface RepositorioInterface {
	...
	// -------------------------
	// DISPONIBILIDADES — QUERIES
	// -------------------------
	//Task<IReadOnlyList<DisponibilidadEspecialidad2025>> SelectDisponibilidades(EspecialidadCodigo2025 especialidadCodigo,DateTime now,int cantidad);
