...
public interface IServiciosDisponibilidades {
	...
	Task<Result<Turno2025Agg>> AgendarTurnoAsync(PacienteId pacienteId, Disponibilidad2025 disponibilidad, IRepositorioDomainServiciosPrivados repositorio);
}
public interface IServiciosGestionTurnos {
	...
	Task<Result<Turno2025Agg>> MarcarComoAusente(TurnoId id, DateTime outcomeFecha, string outcomeComentario, IRepositorioDomainServiciosPrivados repositorio);
	Task<Result<Turno2025Agg>> MarcarComoConcretado(TurnoId id, DateTime outcomeFecha, string? outcomeComentario, IRepositorioDomainServiciosPrivados repositorio);
}
