...
public partial class PacientesModificar : Window {
	private static PacienteView? SelectedPaciente;
	//---------------------public.constructors-------------------//
	...
	public PacientesModificar(PacienteView selectedPaciente) //Constructor con un objeto como parametro ==> Modificarlo.
	{
		InitializeComponent();
		SelectedPaciente = selectedPaciente;
		this.MostrarEnVentana(SelectedPaciente);
	}
		...
		resultado.Switch(
			ok => {
				...
				if (SelectedPaciente is null) {
					...
					SelectedPaciente = new PacienteView(this);
