...
public partial class MedicoMisPacientes : Window {
	public MedicoMisPacientesViewModel VM { get; }

	public MedicoMisPacientes() {
		InitializeComponent();
	...
	//private void ButtonAgregarPaciente(object sender, RoutedEventArgs e) => this.AbrirComoDialogo<MedicoMisPacientesModificar>();
    ...
    private void ClickBoton_AnotarInforme(object sender, RoutedEventArgs e) {
