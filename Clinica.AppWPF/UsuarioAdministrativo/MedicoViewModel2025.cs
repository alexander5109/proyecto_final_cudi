...
public partial class MedicoViewModel2025 : ObservableObject {
	...
	//		} catch (Exception ex) {
	//			MessageBox.Show(
	//				$"Error al obtener el paciente con ID '{EspecialidadCodigo}':\n{ex.Message}",
	...
	public static MedicoViewModel2025 NewEmpty() => new(
		[],
		default,   // id
		string.Empty,   // nombre
