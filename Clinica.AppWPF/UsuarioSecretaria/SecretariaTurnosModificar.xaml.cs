...
public partial class SecretariaTurnosModificar : Window {
	//private static Turno? SelectedTurno;

	//---------------------public.constructors-------------------//
	public SecretariaTurnosModificar() //Constructor vacio ==> Crear.
		{
		InitializeComponent();
		LLenarComboBoxes();
		//SelectedTurno = null;
	...
	//public SecretariaTurnosModificar(Turno selectedTurno) //Constructor con un objeto como parametro ==> Modificarlo.
	//{
	//	InitializeComponent();
	//	LLenarComboBoxes();
